...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssignmentTest.last_modified'
        db.add_column(u'executor_api_assignmenttest', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 9, 25, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssignmentTest.last_modified'
        db.delete_column(u'executor_api_assignmenttest', 'last_modified')
