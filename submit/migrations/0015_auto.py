...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'submit_assignment_correctors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('assignment', models.ForeignKey(orm[u'submit.assignment'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'submit_assignment_correctors', ['assignment_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field correctors on 'Assignment'
        db.delete_table('submit_assignment_correctors')
    ...
    models = {
        ...
        u'submit.assignment': {
            ...
            'correctors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'to_correct'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 15, 0, 0)'}),
