...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.grading_file'
        db.add_column(u'submit_submission', 'grading_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.grading_file'
        db.delete_column(u'submit_submission', 'grading_file')
    ...
    models = {
        ...
        u'submit.assignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 0, 0)'}),
        ...
        u'submit.submission': {
            ...
            'grading_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
