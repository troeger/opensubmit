...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.validity_script_download'
        db.add_column('submit_assignment', 'validity_script_download',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.validity_script_download'
        db.delete_column('submit_assignment', 'validity_script_download')
