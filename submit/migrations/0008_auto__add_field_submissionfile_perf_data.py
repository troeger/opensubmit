...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionFile.perf_data'
        db.add_column('submit_submissionfile', 'perf_data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionFile.perf_data'
        db.delete_column('submit_submissionfile', 'perf_data')
