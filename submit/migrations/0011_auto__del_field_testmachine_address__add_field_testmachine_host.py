...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TestMachine.address'
        db.delete_column('submit_testmachine', 'address')

        # Adding field 'TestMachine.host'
        db.add_column('submit_testmachine', 'host',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TestMachine.address'
        raise RuntimeError("Cannot reverse this migration. 'TestMachine.address' and its values cannot be restored.")
        # Deleting field 'TestMachine.host'
        db.delete_column('submit_testmachine', 'host')
