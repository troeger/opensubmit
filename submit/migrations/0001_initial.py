    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('title', models.CharField(max_length=200)),
                ('gradings', models.ManyToManyField(related_name=b'schemes', to='submit.Grading')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grading_file', models.FileField(null=True, upload_to=submit.models.upload_path, blank=True)),
                ...
                ('assignment', models.ForeignKey(related_name=b'submissions', to='submit.Assignment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('attachment', models.FileField(upload_to=submit.models.upload_path)),
                ('fetched', models.DateTimeField(null=True, editable=False)),
                ('replaced_by', models.ForeignKey(blank=True, to='submit.SubmissionFile', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('courses', models.ManyToManyField(related_name=b'participants', null=True, to='submit.Course', blank=True)),
        ...
        migrations.AddField(
            ...
            name='machine',
            field=models.ForeignKey(related_name=b'test_results', to='submit.TestMachine'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submissiontestresult',
            name='submission_file',
            field=models.ForeignKey(related_name=b'test_results', to='submit.SubmissionFile'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submission',
            name='file_upload',
            field=models.ForeignKey(related_name=b'submissions', blank=True, to='submit.SubmissionFile', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submission',
            name='grading',
            field=models.ForeignKey(blank=True, to='submit.Grading', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submission',
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(related_name=b'assignments', to='submit.Course'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='assignment',
            name='gradingScheme',
            field=models.ForeignKey(related_name=b'assignments', to='submit.GradingScheme'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='assignment',
            name='test_machines',
            field=models.ManyToManyField(to='submit.TestMachine', null=True, blank=True),
            preserve_default=True,
        ),
    ]
