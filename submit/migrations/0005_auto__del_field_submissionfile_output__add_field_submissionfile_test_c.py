...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubmissionFile.output'
        db.delete_column('submit_submissionfile', 'output')

        # Adding field 'SubmissionFile.test_compile'
        db.add_column('submit_submissionfile', 'test_compile', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'SubmissionFile.test_validity'
        db.add_column('submit_submissionfile', 'test_validity', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'SubmissionFile.test_full'
        db.add_column('submit_submissionfile', 'test_full', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SubmissionFile.output'
        db.add_column('submit_submissionfile', 'output', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'SubmissionFile.test_compile'
        db.delete_column('submit_submissionfile', 'test_compile')

        # Deleting field 'SubmissionFile.test_validity'
        db.delete_column('submit_submissionfile', 'test_validity')

        # Deleting field 'SubmissionFile.test_full'
        db.delete_column('submit_submissionfile', 'test_full')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 15, 21, 52, 13, 13262)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 15, 21, 52, 13, 13137)'}),
