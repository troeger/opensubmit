...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Assignment.test_timeout'
        db.delete_column('submit_assignment', 'test_timeout')

        # Deleting field 'Assignment.test_attachment'
        db.delete_column('submit_assignment', 'test_attachment')

        # Deleting field 'Assignment.test_script'
        db.delete_column('submit_assignment', 'test_script')

        # Adding field 'Assignment.attachment_test_timeout'
        db.add_column('submit_assignment', 'attachment_test_timeout', self.gf('django.db.models.fields.IntegerField')(default=30), keep_default=False)

        # Adding field 'Assignment.attachment_test_compile'
        db.add_column('submit_assignment', 'attachment_test_compile', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Assignment.attachment_test_validity'
        db.add_column('submit_assignment', 'attachment_test_validity', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Assignment.attachment_test_full'
        db.add_column('submit_assignment', 'attachment_test_full', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Assignment.test_timeout'
        db.add_column('submit_assignment', 'test_timeout', self.gf('django.db.models.fields.IntegerField')(default=30), keep_default=False)

        # Adding field 'Assignment.test_attachment'
        db.add_column('submit_assignment', 'test_attachment', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Assignment.test_script'
        db.add_column('submit_assignment', 'test_script', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Assignment.attachment_test_timeout'
        db.delete_column('submit_assignment', 'attachment_test_timeout')

        # Deleting field 'Assignment.attachment_test_compile'
        db.delete_column('submit_assignment', 'attachment_test_compile')

        # Deleting field 'Assignment.attachment_test_validity'
        db.delete_column('submit_assignment', 'attachment_test_validity')

        # Deleting field 'Assignment.attachment_test_full'
        db.delete_column('submit_assignment', 'attachment_test_full')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 14, 23, 21, 25, 624468)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 14, 23, 21, 25, 624342)'}),
