...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.file_upload'
        db.add_column('submit_submission', 'file_upload',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='submission', null=True, to=orm['submit.SubmissionFile']),
                      keep_default=False)

        # Deleting field 'SubmissionFile.submission'
        db.delete_column('submit_submissionfile', 'submission_id')


    def backwards(self, orm):
        # Deleting field 'Submission.file_upload'
        db.delete_column('submit_submission', 'file_upload_id')


        # User chose to not deal with backwards NULL issues for 'SubmissionFile.submission'
        raise RuntimeError("Cannot reverse this migration. 'SubmissionFile.submission' and its values cannot be restored.")
    ...
    models = {
        ...
        'submit.submission': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'file_upload': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'submission'", 'null': 'True', 'to': "orm['submit.SubmissionFile']"}),
