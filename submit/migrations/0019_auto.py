...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field test_machines on 'Assignment'
        m2m_table_name = db.shorten_name(u'submit_assignment_test_machines')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('assignment', models.ForeignKey(orm[u'submit.assignment'], null=False)),
            ('testmachine', models.ForeignKey(orm[u'submit.testmachine'], null=False))
        ))
        db.create_unique(m2m_table_name, ['assignment_id', 'testmachine_id'])


    def backwards(self, orm):
        # Removing M2M table for field test_machines on 'Assignment'
        db.delete_table(db.shorten_name(u'submit_assignment_test_machines'))
    ...
    models = {
        ...
        u'submit.assignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 4, 0, 0)'}),
