...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grading.means_passed'
        db.add_column('submit_grading', 'means_passed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grading.means_passed'
        db.delete_column('submit_grading', 'means_passed')
