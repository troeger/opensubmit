...
urlpatterns = patterns('',
    ...
    url(r'^download/(?P<obj_id>\d+)/(?P<filetype>\w+)/secret=(?P<secret>\w+)$', 'submit.views.download', name='download_secret'),
    ...
    url(r'^machines/secret=(?P<secret>\w+)$', 'submit.views.machines', name='machines'),
