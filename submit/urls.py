...
urlpatterns = patterns('',
                       ...
                       url(r'^assignments/(?P<ass_id>\d+)/manual/$', 'submit.views.manual_submit',
                           name='manual_submit'),
                       url(r'^withdraw/(?P<subm_id>\d+)/$', 'submit.views.withdraw', name='withdraw'),
                       url(r'^update/(?P<subm_id>\d+)/$', 'submit.views.update', name='update'),
                       url(r'^course/(?P<course_id>\d+)/gradingtable$', 'submit.views.gradingtable',
                           name='gradingtable'),
                       ...
                       url(r'^download/(?P<obj_id>\d+)/(?P<filetype>\w+)/secret=(?P<secret>\w+)$',
                           'submit.views.download', name='download_secret'),
