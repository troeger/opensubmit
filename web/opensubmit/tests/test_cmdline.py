...
class CmdLineConfigureTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # prepare target directory for install tests
    ...
    def test_configure_call(self):
        ...
        - The second run of 'configure' now finds the adjusted settings file.
          It parses the content and performs some validation and generation
          steps.
        - The last step of 'configure' is to call some Django manage.py
          functionality for the collection of static files.
        ...
        # indirectly triggered Django code, but by the 'configure' code itself.
