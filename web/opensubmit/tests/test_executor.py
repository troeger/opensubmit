...
sys.path.append(os.path.join(os.path.dirname(
    os.path.realpath(__file__)), '../../../executor/opensubmit'))
...
class Executor(StudentTestCase, LiveServerTestCase):
    ...
    def setUp(self):
        ...
        self.config = read_config(os.path.dirname(
            __file__) + "/executor.cfg", override_url=self.live_server_url)
    ...
    def test_validation_test_without_compilation(self):
        # compile
    ...
    def test_inconsistent_state_e_mail(self):
        '''
