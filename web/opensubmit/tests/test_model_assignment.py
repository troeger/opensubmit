...
class AssignmentModelTutorTestCase(SubmitTutorTestCase):
    ...
    def testScriptUrl(self):
        for ass in [self.openAssignment,
                    self.softDeadlinePassedAssignment,
                    self.hardDeadlinePassedAssignment,
                    self.unpublishedAssignment,
                    self.noHardDeadlineAssignment,
                    self.noGradingAssignment]:
