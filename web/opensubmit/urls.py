...
urlpatterns = [
    ...
    url(r'^assignments/(?P<pk>\d+)/lti/submission/$', lti.SubmissionView.as_view(), name='lti_submission'),
    ...
    url(r'^withdraw/(?P<pk>\d+)/lti/$', lti.WithdrawView.as_view(), name='lti_withdraw'),
    ...
    # Backend
    url(r'^teacher/', admin.teacher_backend.urls),
