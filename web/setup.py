...
setup(
    ...
    packages = ['opensubmit', 'opensubmit.cbv', 'opensubmit.admin', 'opensubmit.management.commands', 'opensubmit.migrations', 'opensubmit.models', 'opensubmit.social', 'opensubmit.views'],     # Just add Python packages
