...
localFolder = '/tmp/'
inputFiles = ['task_2.3_strings.txt', 'task_2.3_pi.txt']

executeable = 'java'
jarfile = 'pargrepmon.jar'
parameters = ['-jar', jarfile, localFolder + inputFiles[0], localFolder + inputFiles[1]]

outputFile = 'output.txt'
outputFormat = '^.*?((42;9980.*?23;9951)|(23;9951.*?42;9980)).*?$'
